...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        ## self attention
        mha = self.self_attn.forward(x, x, x, key_padding_mask=self_attn_padding_mask, attention_mask=None)
